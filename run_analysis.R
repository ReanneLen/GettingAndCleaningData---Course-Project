...
names(fulldatasub) <- gsub("mean", "mean", names(fulldatasub))
names(fulldatasub) <- gsub("std", "stdev", names(fulldatasub))
names(fulldatasub) <- gsub("meanFreq", "meanfrequency", names(fulldatasub))
